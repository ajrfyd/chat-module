import { createEl, appendChild, addCssProperties,
  addClass, addId, setMenuState
} from "../js/utils.js";
...
class ChatContainer {
  ...
  init() {
    ...
    //* 랜더링 시 최초 상태
    // this.setChildState();
    addCssProperties(this.$container, { width: this.width + "px", height: this.height + "px" });
  ...
  render() {
    this.test.isOpen ? this.fadeIn() : this.fadeOut();
  };
};
